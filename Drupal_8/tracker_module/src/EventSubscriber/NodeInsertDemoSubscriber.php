...
class NodeInsertDemoSubscriber implements EventSubscriberInterface
{
     ...
     */
    public function onNodeUpdate(NodeUpdateEvents $event)
    {
    ...
    {
        $events[NodeUpdateEvents::DEMO_NODE_UPDATE][] = ['onNodeUpdate'];
        return $events;
    }
